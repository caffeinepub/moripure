...
import type { Inquiry as _Inquiry, Product as _Product } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async incrementVisitCounter(): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, arg2, arg3, to_candid_opt_n7(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        phone: value.phone,
        product: from_candid_Product_n5(_uploadFile, _downloadFile, value.product)
    };
}
function from_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "g100" in value ? Product.g100 : "g250" in value ? Product.g250 : "g500" in value ? Product.g500 : value;
}
